    ...
    await queryInterface.createFunction(
      ...
      `
        ...
        messages AS (
          ...
          RETURNING id, recipient, params, campaign_id, language_code
        ),
        templates AS (
        ...
        SELECT json_build_object('id', m.id, 'recipient', m.recipient, 'params', m.params, 'paramOrder', t.param_order, 'whatsappTemplateLabel', t.whatsapp_template_label, 'campaignId', m.campaign_id, 'language', m.language_code)
